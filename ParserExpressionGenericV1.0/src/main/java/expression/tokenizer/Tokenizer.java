...
public class Tokenizer<T> {
    ...
    final private Operation<T> operation;
    ...
    public T getValue() throws ParserException {
        if (value == null)
    ...
    public void nextToken() throws ParserException {
        ...
        if (Character.isDigit(c)) {
            ...
            try {
                value = operation.parseNumber(strNum);
            } catch (ConstException e) {
                throw new ParserException(expression, "Constant is unsuitable for current mode", curPos);
            }
